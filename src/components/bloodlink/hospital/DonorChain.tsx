        ...
        <div className="mb-4 flex items-center justify-between">
          <div>
            <h3 className="flex items-center gap-1.5 text-sm font-semibold text-slate-900">
              ...
              <span className="rounded-md bg-slate-100 px-1.5 py-0.5 text-[10px] font-bold text-slate-600">{sorted.length}</span>
            </h3>
          ...
          {sorted.map((e, idx) => {
            ...
            return (
              <li key={e.id} className="relative flex items-start gap-3 pb-4 last:pb-0">
                <div className={cn("relative z-10 flex h-8 w-8 shrink-0 items-center justify-center rounded-full ring-2", meta.color, meta.ring)}>
